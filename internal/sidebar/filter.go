...
// FilterByCategory returns modules in the given category.
// If category is empty, all modules are returned (no category filter).
func FilterByCategory(modules []ModuleItem, category string) []ModuleItem {
