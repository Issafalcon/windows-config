...
var (
	...
	// Panel styles are kept for prerequisite and standalone panel rendering.
	// The app uses fixed-size frames so focused and unfocused panels never shift.
	PanelFocused = lipgloss.NewStyle().
			Border(lipgloss.RoundedBorder()).
			BorderForeground(ColorCyan).
			Padding(0, 1)
	PanelUnfocused = lipgloss.NewStyle().
			Border(lipgloss.RoundedBorder()).
			BorderForeground(ColorSurface).
			Padding(0, 1)
)
